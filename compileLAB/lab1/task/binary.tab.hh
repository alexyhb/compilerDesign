...
switch (yytype)
    ...
    // Implementation of make_symbol for each symbol type.
      ...
      static
      symbol_type
      make_BIT (std::string v)
      {
        return symbol_type (token::BIT, std::move (v));
      }
#else
      static
      symbol_type
      make_BIT (const std::string& v)
      {
        return symbol_type (token::BIT, v);
      }
#endif
